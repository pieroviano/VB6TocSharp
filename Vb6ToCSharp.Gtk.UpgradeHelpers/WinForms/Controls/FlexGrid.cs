...
#else
        var cell = SelectedCells != null && SelectedCells.Count > 0 ? SelectedCells[0] : null;
#endif
...
#else
    private bool HasCell => _row >= 0 && _row < base.Rows.Count && _col >= 0 && _col < Columns.Count;
#endif
...
#else
        if (col < 0 || col >= Columns.Count) throw new ArgumentOutOfRangeException(nameof(col), "Subscript out of range");
#endif
    }
