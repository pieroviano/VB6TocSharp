...
namespace Vb6ToCSharp.CodeErrors;

public static class QuickLint
{
    // Option Explicit
    ...
    {
        return TextFiles.ReadEntireFile(tFileName); // the local copy threw on missing/empty files and raised a MsgBox
    }
