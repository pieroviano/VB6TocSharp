...
public static class ConversionUtility
{
    ...
    public static string NextBy(string src, string del = "\"", int ind = 1, bool processVbCommentsUnused = false)
    {
        ...
        {
            nextBy = ConversionUtility.NextBy(Mid(src, l + Len(del)), del, ind - 1);
        }
        return nextBy;
    }
    ...
    public static string NextByP(string src, string del = "\"", int ind = 1)
    {
        ...
        {
            nextByP = ConversionUtility.NextByP(Mid(src, Len(r) + Len(del) + 1), del, ind - 1);
        }
        return nextByP;
    }
    ...
    public static string NextByOp(string src, int ind, ref string op)
    {
        ...
        {
            nextByOp = ConversionUtility.NextByOp(Trim(Mid(src, Len(p) + 3)), ind - 1, ref op);
        }
        return nextByOp;
    }
