...
public sealed class ProjectInfo
{
    ...
    public static ProjectInfo Parse(string text)
    {
        var res = new ProjectInfo();
    ...
    private List<FormControlFile> parsed;

    /// <summary>Designer files of the project's forms and user controls (parsed once).</summary>
    public List<FormControlFile> DesignerFiles()
    {
        if (parsed != null) return parsed;
        parsed = new List<FormControlFile>();
