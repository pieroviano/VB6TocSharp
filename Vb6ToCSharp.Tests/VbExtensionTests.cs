...
using Timer = Vb6ToCSharp.VbExtension.Timer;

namespace Vb6ToCSharp.Tests;

public class VbExtensionTests
{
    ...
    public void PropIndexer_ForwardsToDelegates()
    {
        ...
        var p = new PropIndexer<int, string>(i => store[i], (i, v) => store[i] = v);
        p[1] = "x";
        Assert.Equal("x", p[1]);
        Assert.Null(new PropIndexer<int, string>()[5]);
    }
